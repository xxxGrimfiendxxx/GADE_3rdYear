...
public class UIManager : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        {
            Instance = this;
            DontDestroyOnLoad(gameObject); // Optional: If you want to persist UI across scenes
        }
        else
        {
    ...
    public void ResetUI()
    {
        ...
        UpdatePlayerHealthUI(PlayerInfo.health, 100); // Assuming 100 is max health by default
